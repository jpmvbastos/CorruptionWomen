...
use "CorruptionWomen_Under30-master.dta", clear 
...
esttab using "Results/revision1/under30/Table2A.tex", replace b(%9.3f) keep(corruption3_full $controls) star(* 0.10 ** 0.05 *** 0.01) se r2
...
esttab using "Results/revision1/under30/Table2B.tex", replace b(%9.3f) keep(corruption3_full $controls) star(* 0.10 ** 0.05 *** 0.01) se r2
...
esttab using "Results/revision1/under30/Table2C.tex", replace b(%9.3f) keep(corruption3_full $controls) ///
...
* Export the results for all models in a single table
esttab using "Results/revision1/under30/Table2D.tex", replace b(%9.3f) keep(corruption3_full $controls) ///
star(* 0.10 ** 0.05 *** 0.01) stats(N F_Statistic J_Statistic J_Statistic_pvalue) se 
...
esttab using "Results/revision1/under30/Table3A.tex", replace b(%9.3f) keep(corruption3_full $controls) star(* 0.10 ** 0.05 *** 0.01) se ar2
...
esttab using "Results/revision1/under30/Table3B.tex", replace b(%9.3f) keep(corruption3_full $controls) star(* 0.10 ** 0.05 *** 0.01) se ar2
...
* Export the results for all models in a single table
esttab using "Results/revision1/under30/Table3C.tex", replace b(%9.3f) keep(corruption3_full $controls) ///
star(* 0.10 ** 0.05 *** 0.01) stats(N F_Statistic J_Statistic J_Statistic_pvalue) se
...
* Export the results for all models in a single table
esttab using "Results/revision1/under30/Table3D.tex", replace b(%9.3f) keep(corruption3_full $controls) ///
star(* 0.10 ** 0.05 *** 0.01) stats(N F_Statistic J_Statistic J_Statistic_pvalue) se 
